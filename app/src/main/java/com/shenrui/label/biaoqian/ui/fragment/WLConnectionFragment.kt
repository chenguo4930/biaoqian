...
class WLConnectionFragment : BaseFragment(), FragmentBackHandler {
    ...
    private val mWLConnectionList: ArrayList<WLConnectionDetailBean> by lazy {
        ArrayList<WLConnectionDetailBean>()
    }
...
//        mWLConnectionList.sort()
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): WLConnectionFragment {
